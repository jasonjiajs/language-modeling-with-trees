...
## Summary
We find that tree-based methods such as XGBoost, Random Forest, CART and Optimal Classification Tree (OCT) can sometimes outperform neural networks on next character prediction while offering interpretability. This suggests tree-based methods may be a viable alternative to neural networks for small to mid-sized language models.
